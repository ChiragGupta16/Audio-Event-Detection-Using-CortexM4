...
#define NB_MFCC_WIN_COEFS_CONFIG1_Q31 256
extern const q31_t mfcc_window_coefs_config1_q31[NB_MFCC_WIN_COEFS_CONFIG1_Q31];



#define NB_MFCC_WIN_COEFS_CONFIG1_Q15 256
